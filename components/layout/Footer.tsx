      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 sm:col-span-2 lg:col-span-2">
            <Link href="/" className="text-xl md:text-2xl font-bold text-black mb-4 inline-block">
            ...
            <p className="text-gray-600 text-sm mt-4 max-w-md">
              Building secure user-first experiences powered by SSO authentication
        ...
        <div className="mt-8 md:mt-12 pt-6 md:pt-8 border-t border-gray-200">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-xs md:text-sm text-gray-600 text-center md:text-left">
              © {new Date().getFullYear()} Fusion Capture. All rights reserved.
            </p>
